...
public class App {
    public static void main(String[] args) throws Exception {
        Student s1 = new UnderGradStudent("Kelsey Omaro", "11563", 3.854);
        Student s2 = new UnderGradStudent("Jeff Reidus", "99872", 2.731);
        ...
        {
            System.out.println(list.get(i).getSerialData());
        }
